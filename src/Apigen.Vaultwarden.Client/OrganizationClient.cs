...
public partial class OrganizationClient
{
  ...
  /// </summary>
  public async Task<OkResult> OrganizationImportAsync(Apigen.Vaultwarden.Models.OrganizationImportRequestModel organizationImportRequestModel, CancellationToken cancellationToken = default)
  {
