...
public partial class InfoClient
{
  ...
  /// </summary>
  public async Task<JsonElement> InfoGetAliveAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> InfoGetNowAsync(CancellationToken cancellationToken = default)
  {
    string url = "api/now";
  ...
  /// </summary>
  public async Task InfoGetVersionAsync(CancellationToken cancellationToken = default)
  {
