...
public partial class SettingsClient
{
  ...
  /// </summary>
  public async Task<DomainsResponseModel> SettingsGetDomainsAsync(SettingsGetDomainsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DomainsResponseModel> SettingsPutDomainsAsync(Apigen.Vaultwarden.Models.UpdateDomainsRequestModel updateDomainsRequestModel, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DomainsResponseModel> SettingsPostDomainsAsync(Apigen.Vaultwarden.Models.UpdateDomainsRequestModel updateDomainsRequestModel, CancellationToken cancellationToken = default)
  {
    string url = "api/settings/domains";
