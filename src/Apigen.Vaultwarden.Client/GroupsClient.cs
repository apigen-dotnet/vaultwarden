...
public partial class GroupsClient
{
  ...
  /// </summary>
  public async Task<GroupResponseModel> GetAsync(string orgId, string id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<GroupResponseModel> UpdateAsync(string orgId, string id, Apigen.Vaultwarden.Models.GroupRequestModel groupRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task<GroupResponseModel> GroupsPostPutAsync(string orgId, string id, Apigen.Vaultwarden.Models.GroupRequestModel groupRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task<GroupDetailsResponseModel> GroupsGetDetailsAsync(string orgId, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task<GroupResponseModelListResponseModel> GroupsGetOrganizationGroupsAsync(string orgId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task<GroupResponseModel> GroupsPostAsync(string orgId, Apigen.Vaultwarden.Models.GroupRequestModel groupRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task GroupsBulkDeleteAsync(string orgId, Apigen.Vaultwarden.Models.GroupBulkRequestModel groupBulkRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
    ...
    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "DELETE", url);
      string json = JsonSerializer.Serialize(groupBulkRequestModel, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<GroupDetailsResponseModelListResponseModel> GroupsGetOrganizationGroupDetailsAsync(string orgId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task<JsonElement> GroupsGetUsersAsync(string orgId, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task GroupsPostDeleteAsync(string orgId, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task GroupsPostDeleteUserAsync(string orgId, string id, string orgUserId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
