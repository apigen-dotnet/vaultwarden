...
public partial class FoldersClient
{
  ...
  /// </summary>
  public async Task<FolderResponseModel> GetAsync(string id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<FolderResponseModel> UpdateAsync(string id, Apigen.Vaultwarden.Models.FolderRequestModel folderRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<FolderResponseModel> FoldersPostPutAsync(string id, Apigen.Vaultwarden.Models.FolderRequestModel folderRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<FolderResponseModelListResponseModel> FoldersGetAllAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<FolderResponseModel> FoldersPostAsync(Apigen.Vaultwarden.Models.FolderRequestModel folderRequestModel, CancellationToken cancellationToken = default)
  {
    string url = "api/folders";
  ...
  /// </summary>
  public async Task FoldersPostDeleteAsync(string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
