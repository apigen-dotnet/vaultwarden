...
public partial class TwoFactorClient
{
  ...
  public async Task<TwoFactorProviderResponseModel> TwoFactorDisableAuthenticatorAsync(Apigen.Vaultwarden.Models.TwoFactorAuthenticatorDisableRequestModel twoFactorAuthenticatorDisableRequestModel, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(twoFactorAuthenticatorDisableRequestModel, JsonConfig.Default);
  ...
  public async Task<TwoFactorWebAuthnResponseModel> TwoFactorDeleteWebAuthnAsync(Apigen.Vaultwarden.Models.TwoFactorWebAuthnDeleteRequestModel twoFactorWebAuthnDeleteRequestModel, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "DELETE", url);
      string json = JsonSerializer.Serialize(twoFactorWebAuthnDeleteRequestModel, JsonConfig.Default);
      HttpClientLog.LogTraceRequestBody(_logger, "DELETE", "application/json", json);
      StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
      HttpRequestMessage httpRequest = new HttpRequestMessage(HttpMethod.Delete, url) { Content = content };
      HttpResponseMessage response = await _httpClient.SendAsync(httpRequest, cancellationToken);
