...
public partial class PoliciesClient
{
  ...
  /// </summary>
  public async Task<PolicyDetailResponseModel> GetAsync(string orgId, int type, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<PolicyResponseModel> UpdateAsync(string orgId, int type, Apigen.Vaultwarden.Models.PolicyRequestModel policyRequestModel, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
  ...
  /// </summary>
  public async Task<PolicyResponseModelListResponseModel> PoliciesGetAllAsync(string orgId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task<PolicyResponseModelListResponseModel> PoliciesGetByTokenAsync(string orgId, PoliciesGetByTokenRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task<PolicyResponseModel> PoliciesGetMasterPasswordPolicyAsync(string orgId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId
  ...
  /// </summary>
  public async Task<PolicyResponseModel> PoliciesPutVNextAsync(string orgId, int type, Apigen.Vaultwarden.Models.SavePolicyRequest savePolicyRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["orgId"] = orgId,
