...
/// </summary>
public partial class HibpClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal HibpClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task HibpGetAsync(HibpGetRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "api/hibp/breach".BuildUrl(request: request);
