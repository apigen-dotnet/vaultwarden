...
/// </summary>
public partial class OrganizationBillingVNextClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal OrganizationBillingVNextClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task OrganizationBillingVNextGetWarningsAsync(string organizationId, OrganizationBillingVNextGetWarningsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["organizationId"] = organizationId
    };
    string url = "api/organizations/{organizationId}/billing/vnext/warnings".BuildUrl(pathParams, request);
