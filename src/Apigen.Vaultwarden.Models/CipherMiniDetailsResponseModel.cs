...
/// <summary>
/// CipherMiniDetailsResponseModel from OpenAPI schema.
/// Schema path: #/components/schemas/CipherMiniDetailsResponseModel
/// </summary>
public partial class CipherMiniDetailsResponseModel
{
