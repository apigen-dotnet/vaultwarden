...
/// </summary>
public partial class OrganizationBillingClient
{
  ...
  /// </summary>
  public async Task OrganizationBillingGetMetadataAsync(string organizationId, CancellationToken cancellationToken = default)
  {
